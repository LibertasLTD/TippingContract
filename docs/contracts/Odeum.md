...
```solidity
function INITIAL_CAP() external view returns (uint256)
```

The maximum possible amount of minted tokens
...
```solidity
function configure(address teamWallet) external nonpayable
```
