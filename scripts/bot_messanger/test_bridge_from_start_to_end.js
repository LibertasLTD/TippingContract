...
// const libertasTokenAddressJSON = JSON.parse(
//   fs.readFileSync("../libertas_token_address.json", "utf8")
// );
//
...
//                     console.log(
//                       `Performed request bridging to end with new balance of: ${newBalance}`
//                     );
//                     callback();
//                   });
//                 })
